...
export default function WorkerSidebar() {
  ...
  return (
    <aside className="w-full lg:w-72 bg-slate-900 text-slate-700 flex flex-col h-screen sticky top-0 overflow-y-auto no-scrollbar border-r border-slate-800/50">
      ...
      <nav className="flex-grow px-4 space-y-1.5 pb-10">
        <div className="px-4 mb-4">
           <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-700">Professional Panel</p>
        </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3.5">
                <Icon size={20} className={cn(isActive ? "text-white" : "text-slate-700 group-hover:text-primary transition-colors")} />
      ...
      <div className="p-4 mt-auto border-t border-slate-800/50">
         <button 
           ...
           className="w-full flex items-center gap-3.5 px-4 py-4 hover:bg-red-500/10 hover:text-red-500 rounded-2xl font-bold transition-all text-slate-700"
         >
           <LogOut size={20} />
