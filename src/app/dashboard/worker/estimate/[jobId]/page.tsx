...
export default function WorkerEstimatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!user) {
      setError('You must be logged in to submit an estimate');
      return;
    }
    setSaving(true);
    setError('');
  ...
  if (success) {
    return (
      <div className="py-24 flex flex-col items-center justify-center bg-white p-6 text-center rounded-[2.5rem] border border-slate-100 shadow-sm">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  step="0.01"
                  placeholder="0.00"
                  className="w-full pl-9 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold focus:ring-2 focus:ring-primary focus:border-primary transition-all shadow-none outline-none"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold focus:ring-2 focus:ring-primary focus:border-primary transition-all shadow-none outline-none"
